...
```{r}
overall_averages = read.csv("~/data-analysis-projects-capstone/case_studies/capstone_bellabeat/data_tables/overall_averages.csv")
filtered_steps = read.csv('~/data-analysis-projects-capstone/case_studies/capstone_bellabeat/data_tables/filtered_steps.csv')
steps_by_date = read.csv("~/data-analysis-projects-capstone/case_studies/capstone_bellabeat/data_tables/steps_by_date.csv")
steps_by_day = read.csv("~/data-analysis-projects-capstone/case_studies/capstone_bellabeat/data_tables/steps_by_day.csv")
